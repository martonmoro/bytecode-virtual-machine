...
void compile(const char* source) {
    ...
    for (;;) {
        ...
        // show—by placing a number inside the format string. 
        ...
        // We need to limit the length like that because the lexeme points into 
        // the original source string and doesn’t have a terminator at the end.
